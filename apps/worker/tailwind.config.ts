  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-slow": { "0%,100%": { transform: "translateY(0) translateX(0)" }, "33%": { transform: "translateY(-14px) translateX(6px)" }, "66%": { transform: "translateY(-6px) translateX(-8px)" } },
        "pulse-soft": { "0%,100%": { opacity: "0.45" }, "50%": { opacity: "0.85" } },
